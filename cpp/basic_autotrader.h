...
#ifndef CPPREADY_TRADER_GO_BASIC_AUTOTRADER_H
#define CPPREADY_TRADER_GO_BASIC_AUTOTRADER_H
...
class BasicAutoTrader : public ReadyTraderGo::BaseAutoTrader
{
public:
    explicit BasicAutoTrader(boost::asio::io_context& context);
...
#endif //CPPREADY_TRADER_GO_BASIC_AUTOTRADER_H
